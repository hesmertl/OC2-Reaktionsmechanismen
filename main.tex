...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\linewidth]{Bilder/clemmensen-Reduktion.png}
\end{figure}

\subsubsection{Katalytische Hydrierung}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.55\linewidth]{Bilder/Katalytische Hydrierung mit Pt.png}
\end{figure}


\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\linewidth]{Bilder/katalytische Hydrierung Raney.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{Bilder/Wolff-kishner-Reduktion.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{Bilder/wolff-kishner-Mechanismus.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{Bilder/Reduktion mit Metallhydriden.png}
\end{figure}
...
einbezogen sind und die einen dynamischen Ringstrom besitzen.\\

Zudem gilt die altbekannte \textbf{ Hückel-Regel}:
\begin{enumerate}
...
\textbf{anti-armatsiche Systeme} sind weniger stabil als ihre cyclischen Analoga. 
\textbf{nicht aromatische Systeme} besitzen ähnliche DElokalisierungsentalphien wie ihre acyclischen Analoga.
