...
\subsubsection{Bildung des ter-Butylesters als Schutzgruppe}
\begin{figure}[H]
	\centering 
...
\subsubsection{Decarboxylierung}
\subsubsection*{Hunsdiecker-Reaktion}
\begin{figure}[H]
	\centering 
...
\subsubsection*{Decarboxylierung von $\beta$-Carbonsäuren}
...
\subsection{Carbonsäurederivate}
Carbonsäurederivate sind Strukturell Carbonsäuren,
bei denen Die OH-Gruppe gegen verschiedene Substituenten ersetzt wurden.
...
\subsubsection*{Darstellungsmethoden}
\begin{figure}[H]
	\centering
	\includegraphics[width=1.1\linewidth]{Bilder/Säurechlorid Thionylchlorid.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{Bilder/Säurechloride Phosphorpentachlorid.png}
	\caption{Darstellung der Säurechloride aus Phosphorpentachlorid}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{Bilder/Säurechloride Halogenidaustausch.png}
	\caption{Halogenidaustausch der Säurechloride}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{Bilder/anhydride aus Phosphorpentoxid.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{Bilder/Anhydride in situ aktivierung.png}
